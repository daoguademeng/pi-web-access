...
export const webAccessTool = defineTool({
  name: "web_access",
  label: "Web Access",
  description: "⚠️ GATE: Is this real-time/now/latest data? → no search, use browser-tools. Is the URL known? → no search, use fetch (static) or browser-tools (JS/login). Otherwise: Internet access, including web search via Grok/Exa/Zhipu, docs lookup via Context7, and page fetching and site mapping via Tavily/Firecrawl.",
